// archive/main_monolith.jsx
// BACKUP — original monolithic src/main.jsx before GitHub-ready refactor.
// Do not import or run this file. Preserved for archaeological purposes.
// The canonical app is now src/App.jsx + src/main.jsx (clean bootstrap).

import React, { useEffect, useState } from 'react';
import ReactDOM from 'react-dom/client';
import InventoryPanel from './src/components/InventoryPanel';
import DriverEarningsPanel from './src/components/DriverEarningsPanel';
import { MoveMastersAPI } from './src/api/moveMastersApi';

/* ==========================================================================
 SCHEMAS & STATUS FLOW
 NOTE: These JobStatus values are UPPERCASE strings ('SURVEY', 'LOADING', etc.)
 but the canonical jobSchema.js uses lowercase ('survey', 'loading', etc.).
 This mismatch meant role-panel conditions never matched real Firestore data.
 Fixed in the refactored App.jsx.
========================================================================== */
